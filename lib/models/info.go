...
func (m *Info) validateBrokerAPIVersion(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("broker_api_version", "body", string(m.BrokerAPIVersion)); err != nil {
		return err
	}
...
func (m *Info) validateUsbVersion(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("usb_version", "body", string(m.UsbVersion)); err != nil {
		return err
	}
